...
- They are intended mainly as human-facing orientation surfaces in Obsidian. Agents should treat them as generated context layers on top of the SQLite-backed note store, not as the canonical knowledge format.
