...
Shared, persistent memory for AI coding assistants, built on the Zettelkasten method. One knowledge base for all your tools. TypeScript/Bun, SQLite FTS5, Markdown files with YAML frontmatter. Entry point: `mcp-server.ts` (MCP stdio).
